...
project = 'tenjint'
copyright = '2019, BedRock Systems, Inc'
...
latex_documents = [
    (master_doc, 'tenjint.tex', 'tenjint Documentation',
     'Jonas Pfoh, Sebastian Vogl', 'manual'),
]
...
man_pages = [
    (master_doc, 'tenjint', 'tenjint Documentation',
     [author], 1)
]
